...
class LineLayout
{
  ...
  public:
    ...
    int numCharsInLine;
    enum validLevel
    { llInvalid, llCheckTextAndStyle, llPositions, llLines } validity;
    int xHighlightGuide;
...
class Editor:public DocWatcher
{
 ...
 /** In twoPhaseDraw mode, drawing is performed in two phases, first the background
	* and then the foreground. This avoids chopping off characters that overlap the next run. */
    ...
    bool dwelling;
    enum
    { selChar, selWord, selLine } selectionType;
    Point ptMouseLast;
    bool inDragDrop;
    ...
    enum
    { notPainting, painting, paintAbandoned } paintState;
    PRectangle rcPaint;
    ...
    ColourAllocated TextBackground (ViewStyle & vsDraw, bool overrideBackground, ColourAllocated background, bool inSelection, bool inHotspot,
      int styleMain, int i, LineLayout * ll);
    ...
    void DrawEOL (Surface * surface, ViewStyle & vsDraw, PRectangle rcLine, LineLayout * ll,
      ...
      bool overrideBackground, ColourAllocated background, bool drawWrapMark, ColourAllocated wrapColour);
    void DrawLine (Surface * surface, ViewStyle & vsDraw, int line, int lineVisible, int xStart, PRectangle rcLine, LineLayout * ll, int subLine = 0);
