...
void BrzSequenceOptimised_ackup_optimised (struct comp *comp, int port)
{
    struct BrzSequenceOptimised_ *c = (struct BrzSequenceOptimised_ *) comp;
...
void BrzSequenceOptimised_ackdown_optimised (struct comp *comp, int port)
{
    struct BrzSequenceOptimised_ *c = (struct BrzSequenceOptimised_ *) comp;
        ...
        case 'T':
            {
                ...
                channel[channum].ackup.fct = BrzSequenceOptimised_ackup_optimised;
                channel[channum].ackdown.fct = BrzSequenceOptimised_ackdown_optimised;
                c->nb_T_elements++;
            }
            break;
        default:
            fprintf (stderr, "Error in BrzSequenceOptimised's specString (%s), position %d\n", specString, i + 1);
            exit (EXIT_FAILURE);
        }
    }
